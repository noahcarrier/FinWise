  ...
  return (
    <div className="grid-cols-2 lg:grid xl:grid-cols-4 ">
      <div className="mx-9 mb-12 flex flex-col rounded-lg bg-yellow-300 text-surface text-black ">
        ...
        <div className="p-6">
          <h5 className="mb-2 text-3xl font-medium leading-tight text-center">Memory</h5>
      ...
      <div className="mx-9 mb-12 flex flex-col  rounded-lg bg-yellow-300 text-surface text-black ">
        ...
        <div className="p-6">
          <h5 className="mb-2 text-3xl font-medium leading-tight text-center">Mastery</h5>
          {/* <p className="mb-4 text-base">
                This is a longer card with supporting text below as a natural
                lead-in to additional content. This content is a little bit
                longer.
      ...
      <div className="mx-9 mb-12 flex flex-col  rounded-lg bg-yellow-300 text-surface text-black ">
        ...
        <div className="p-6 ">
          <h5 className="mb-2 text-3xl font-medium leading-tight text-center">Strategy</h5>
          {/* <p className="mb-4 text-base">
                This is a longer card with supporting text below as a natural
      ...
      <div className="mx-9 mb-12 flex flex-col  rounded-lg bg-yellow-300 text-surface text-black ">
        ...
        <div className="p-6">
          <h5 className="mb-2 text-3xl font-medium leading-tight text-center">Sprints & Breaks</h5>
          {/* <p className="mb-4 text-base">
                This is a longer card with supporting text below as a natural
                lead-in to additional content. This content is a little bit
                longer.
